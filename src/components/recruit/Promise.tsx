...
export default function Promise() {
  return (
    <section id="promise" className="scroll-mt-16 bg-offwhite">
      <div className="mx-auto max-w-5xl px-4 py-16 md:py-24">
        <p className="text-sm font-medium uppercase tracking-widest text-gold">Our Promise</p>
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-3">
          {PROMISES.map((p) => (
            ...
            >
              ...
              <p className="mt-3 font-bold leading-snug text-black">{p.title}</p>
              <p className="mt-2 text-sm leading-relaxed text-sub">{p.desc}</p>
            </div>
          ))}
        </div>
      </div>
