export default function Hero() {
  return (
    <section id="top" className="scroll-mt-16 bg-gray-100 pt-16 lg:pt-20">
      <div className="mx-auto max-w-5xl px-4 py-12 md:py-20">
        ...
        <h1 className="mt-3 text-[2rem] font-bold tracking-tight text-black min-[360px]:text-4xl md:text-6xl">
          外山建設について
        </h1>
